...
namespace App\Models\Datasus\Sinasc\The;
...
use App\Models\Datasus\Sinasc\SinascDatasus;
use App\Models\Dataset;

class TheSinascDatasus extends SinascDatasus
{
    use HasFactory;

    public $keys = ['numerodn', 'dtnasc'];
